// src/features/error/pages/Error404Page.tsx
import Link from 'next/link';
import pacifico from '@/adapters/ui/layout/Layout';
import orbitron from '@/adapters/ui/layout/Layout';
import { ErrorController } from '@/adapters/controllers/ErrorController';

export function Error404Page() {
  const { title, message } = ErrorController.handle404();
